// import fetch from 'node-fetch'; // No es necesario aquí

let handler = async (m, { conn, text, usedPrefix, command }) => {
  try {
    if (command.toLowerCase() === 'declaracion' || command.toLowerCase() === 'dclarar' || command.toLowerCase() === 'declaración') {
    ...
    } else if (command.toLowerCase() === 'si') {
