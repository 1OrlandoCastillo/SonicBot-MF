...
export async function handler(chatUpdate) {
    ...
    try {
        ...
        for (let plugin of processedPlugins) {
            ...
            if (isMatchCommand) {
                // Bloque de ejecución de comando
        ...
        // Bloques de anti-link, anti-img, anti-audio, anti-video, etc.
        // Se mantienen intactos, solo se eliminan los mensajes de "comando no existe"
        ...
        // Auto-lectura y modos IA / Hot / Ilegal siguen intactos
