...
vimport { promises as fs } from 'fs'
import { Sticker } from 'wa-sticker-formatter'

export async function writeExif(buffer, packname = 'hecho por', author = 'AdriBot el mejor') {
  ...
  // construir sticker con metadata
  const webpBuffer = await sticker.build()

  // opcional: guardar en disco si quieres depurar
  await fs.writeFile('./sticker.webp', webpBuffer)
